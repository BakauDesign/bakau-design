    ...
    return (
        <button
            ...
            class={`
                ...
                ${variant === "secondary" && "bg-linear-[90deg,#212121_0%,#2B2B2B_50%,#212121_100%] hover:bg-linear-[90deg,#212121_0%,#333333_50%,#212121_100%] active:bg-linear-[90deg,#212121_0%,#2B2B2B_50%,#212121_100%] active:border-[1.5px] active:border-neutral-600 text-custom-neutral-0"}
